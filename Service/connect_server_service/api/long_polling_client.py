...
class LongPollingClient:
    ...
    def __init__(self, server_url: str, client_id: str, device_id: Optional[str] = None, poll_interval: int = 2):
        """
        初始化长轮询客户端。
        ...
        # Used to suppress stale disconnect callbacks during manual reconnect/shutdown.
