...
from Module.UFC_UGC_ZOS_Test.function.modbus.Modbus_Type import Modbus_Slave_Ids, Modbus_Slave_Type
...
响应报文解析
    ...
    def __init__(self, slave_id, function_code, response, response_hex,
        ...
        self.response_parser:  Modbus_Response_Diffent_Type_Not_Each_Mouse_Cage = None
        self.init_self()
        pass
...
class Modbus_Response_UFC(Modbus_Response_Parents):
    ...
    def parser_function_code_5(self):
        ...
        valve_desc=['鼠笼1气路','鼠笼1气路','鼠笼2气路','鼠笼3气路','鼠笼4气路','鼠笼5气路','鼠笼6气路','鼠笼7气路','鼠笼8气路','参考气气路','ZOS采样阀气路','气泵','UFC']
        valve_state_desc = [['闭合','断开'],['闭合','断开'],['闭合','断开'],['闭合','断开'],['闭合','断开'],['闭合','断开'],['闭合','断开'],['闭合','断开'],['闭合','断开'],['闭合','断开'],['运行','断开'],['运行','停止']]
        valve_index= 0
        j = 0
        for i in range(len(self.response_struct['data'])):
            match i:
                ...
                case 3:
                    return_datas.append({
                        "desc": port_types[j],
                        'value': valve_state_desc[valve_index][0] if int(self.response_struct['data'][i]) == 255 else valve_state_desc[valve_index][1]
                    }
                    )
                    j += 1
                    pass
                ...
                case 3:
                    match self.response_struct['data'][1]:
                        ...
                        case 1:
                            return_datas.append({
                                "desc": port_types_1[j],
                                'value':port_types_1_value[0]+":"+ port_types_1_value[1][1] if int("".join(self.int_to_8bit_binary(
